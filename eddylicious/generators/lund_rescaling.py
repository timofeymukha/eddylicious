...
def lund_generate(readFunc,
    ...
    ----------
    readFunc : function 
        The function to use for reading in data, generated by the reader.
        Should containt the reader's name in the attribute "reader".
    writer: str
